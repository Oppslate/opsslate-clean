...
export const assembleSurfaces = internalQuery({
  args: {
  ...
  handler: async (ctx, args): Promise<HeliosEuclidSurfaceAssemblyResult> => {
    ...
    return assembleHeliosEuclidSurfaces(model, args.input);
  },
});
