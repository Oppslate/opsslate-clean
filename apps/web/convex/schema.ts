...
export default defineSchema({
  ...
  heliosCanonicalPlanWriterPilots: defineTable({
    ...
    activationEligible: v.optional(v.boolean()),
    semanticReviewRequired: v.optional(v.boolean()),
    semanticReconciliationVersion: v.optional(v.number()),
    semanticReconciliationStatus: v.optional(v.union(
      v.literal("not_started"),
      v.literal("completed"),
    )),
    semanticSource: v.optional(v.literal("canonical_plan_artifact")),
    reconciliationOpenAiCallCount: v.optional(v.number()),
    removedModelViewCount: v.optional(v.number()),
    removedModelReferenceCount: v.optional(v.number()),
    globallyResolvedReferenceCount: v.optional(v.number()),
    inputFingerprint: v.string(),
    canonicalPageCount: v.number(),
    ...
    pageKindMatchCount: v.optional(v.number()),
    printedPageNumberMatchCount: v.optional(v.number()),
    sheetNumberMatchCount: v.optional(v.number()),
    titleMatchCount: v.optional(v.number()),
    disciplineMatchCount: v.optional(v.number()),
    issueDateMatchCount: v.optional(v.number()),
    revisionMarkerMatchCount: v.optional(v.number()),
    viewSemanticPageMatchCount: v.optional(v.number()),
    referenceSemanticMatchCount: v.optional(v.number()),
    authoritativeViewCount: v.number(),
    shadowViewCount: v.number(),
    authoritativeReferenceCount: v.number(),
    shadowReferenceCount: v.number(),
    authoritativeCalibrationCount: v.optional(v.number()),
    shadowCalibrationCount: v.optional(v.number()),
    calibrationSemanticMatchCount: v.optional(v.number()),
  ...
  heliosCivilGeometryRecords: defineTable({
    ...
    typicalSections: v.optional(v.array(v.object({ name: v.string(), stationStart: v.number(), stationEnd: v.number(), laneWidthLeft: v.optional(v.number()), laneWidthRight: v.optional(v.number()), shoulderWidthLeft: v.optional(v.number()), shoulderWidthRight: v.optional(v.number()), crossSlopeLeftPercent: v.optional(v.number()), crossSlopeRightPercent: v.optional(v.number()) }))),
