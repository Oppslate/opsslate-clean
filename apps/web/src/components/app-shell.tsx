...
function OpsSlateFooter({ sidebarCollapsed, showSidebar }: { sidebarCollapsed: boolean; showSidebar: boolean }) {
  ...
  return (
    <footer data-print-hide="true" className={`sticky bottom-0 z-[60] border-t border-white/8 bg-[#0d1218]/96 backdrop-blur-xl supports-[backdrop-filter]:bg-[#0d1218]/84 shadow-[0_-10px_30px_rgba(0,0,0,0.35)] transition-[margin] duration-200 ${showSidebar ? (sidebarCollapsed ? "lg:ml-[72px]" : "lg:ml-60") : ""}`}>
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background bg-[radial-gradient(circle_at_70%_0%,rgba(249,115,22,0.08),transparent_28%)]">
      ...
      <div className="flex flex-1">
        ...
        {/* Top bar */}
        {showTopBar && <div data-print-hide="true" className="mb-5 flex items-center justify-end gap-3">
